    ...
    public partial class MapPage : Form
    {
        ...
        private void DrawMap()
        {
            ...
            if (Informations.GlobalPoints.Count >= 2)
            {
                ...
                var startPoint = Informations.GlobalPoints[0];
                var endPoint = Informations.GlobalPoints[int.Parse(endNode)];

                Console.WriteLine($"Start Point: {startPoint}, End Point: {endPoint}");

                var route2 = GoogleMapProvider.Instance.GetRoute(endPoint, startPoint, false, false, 14);
                if (route2 != null && route2.Points.Count > 0)
                {
                    ...
                    var km = DistanceBetweenTwoPoints(endPoint, startPoint);
                    Console.WriteLine($"Calculated Distance: {km} km");
                ...
                {
                    Console.WriteLine("Route could not be retrieved. Check your API or coordinates.");
